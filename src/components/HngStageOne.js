    ...
    <div className="container">
      <div className="Profile">
        <img
          ...
          alt="profile__img"
        ></img>
        <p className="profile_p" id="twitter">
          @Mo_diyyah
        </p>
        <p className="slack_p" id="slack_id">
          Rodiyyah
        </p>
      </div>
      <div className="links">
        <div className="anchorLinks">
          <a
            className="aLinks"
            href="https://twitter.com/Mo_Diyyah?s=20&t=5RxJpLViYUFTlHeheBLXxw"
            id="twitter"
          >
            <p>Twitter</p>
          </a>
        ...
        <div className="anchorLinks">
          <Link to="/contact" className="aLinks" id="contact">
            <p>Contact</p>
          </Link>
        </div>
      </div>
